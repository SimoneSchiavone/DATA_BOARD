...
public class Testbench2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Benvenuto nel testbench del progetto DataBoard");
		System.out.println("Prova Implementazione 2\n\n");
		...
		try {
			System.out.println("creo una categoria inserendo una password sbagliata, mi aspetto una IncorrectPassword");
		...
		try {
			System.out.println("inserisco una password sbagliata, mi aspetto una IncorrectPassword");
		...
		try {
			System.out.println("aggiungo un amico inserendo una password sbagliata, mi aspetto una IncorrectPassword");
		...
		try {
			System.out.println("rimuovo un amico inserendo una password sbagliata, mi aspetto una IncorrectPassword");
		...
		try {
			System.out.println("rimuovp un amico inserendo un amico nullo, mi aspetto una NullPointerException");
		...
		try {
			System.out.println("aggiungo un dato in bacheca con una password sbagliata, mi aspetto una IncorrectPassword");
		...
		try {
			System.out.println("invoco una get inserendo una password sbagliata, mi aspetto una IncorrectPassword");
		...
		try {
			...
			System.out.println("Aggiungo un like alla copia ottenuta e poi invoco la display per dimostrare che ho fatto una deepcopy del dato");
			cp.display();
			posttmp.display();
			cp.addlike("anna");
			cp.display();
		...
		bacheca.printelements("cat2");
		try {
			System.out.println("invoco una remove inserendo una password sbagliata, mi aspetto una IncorrectPassword");
		...
		List<Data> templist;
		try {
			System.out.println("invoco la getdatacategory con password errata, mi aspetto una IncorrectPassword");
		...
		//Da notare che Marco mette like al dato tramonto. Marco ha accesso ad almeno una categoria in cui si trova tramonto cioè
		//cat1.
		...
		try {
			System.out.println("invoco getiterator inserendo una password sbagliata, mi aspetto una IncorrectPassword");
